    ...
    >
      ...
      <div className="about-container">
        ...
        <div className="about-content-enhanced">
            ...
            <div className="content-wrapper">
              ...
              <div className="about-paragraphs">
                <p className="paragraph-enhanced">
                  ...
                  Much blood has been wasted in the streets of Lebanon
                  throughout its history.
                </p>
                <p className="paragraph-enhanced">
                  <span className="paragraph-icon">🏥</span>
                  Yet, blood banks are almost empty and families of patients in
                  need of blood struggle to find potential donors every day.
                </p>
                <p className="paragraph-enhanced">
                  <span className="paragraph-icon">🎯</span>
                  Our mission is to improve the anonymous and voluntary blood
                  donation system in Lebanon — for that, we created a movement.
                </p>
              </div>
          ...
          <div
            className={`about-visual-enhanced ${isVisible ? 'visible' : ''}`}
          >
        ...
        <div className={`cta-banner ${isVisible ? 'visible' : ''}`}>
          <div className="banner-content">
            ...
            <div className="banner-actions">
              <Link to="/donate-blood" className="banner-btn primary">
